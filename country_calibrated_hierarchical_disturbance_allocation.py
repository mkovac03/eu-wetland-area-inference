...
def simulate_allocations(
    ...
    X_draws = np.zeros((n_draws, n_countries, n_classes, n_dist), dtype=np.float64)
    disturbed_draws = np.zeros((n_draws, n_countries), dtype=np.float64)
    peat_disturbed_draws = np.zeros((n_draws, n_countries), dtype=np.float64)
